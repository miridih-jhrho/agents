...
Manage cursor session history - list, load, alias, and edit sessions stored in `~/.cursor/sessions/`.
...
console.log('Path: ~/.cursor/sessions/' + session.filename);
console.log('');
...
- Sessions are stored as markdown files in `~/.cursor/sessions/`
