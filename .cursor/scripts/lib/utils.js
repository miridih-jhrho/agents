/**
 * Cross-platform utility functions for hooks and scripts
...
function getAliasesPath() {
  return path.join(getCursorDir(), 'session-aliases.json');
}
...
/**
 * Get short session ID from getSessionId()
...
/**
 * Output to stdout (returned to agent)
 */
function output(data) {  
  console.log(JSON.stringify({additional_context:  data.toString()}, null, 2));
}
